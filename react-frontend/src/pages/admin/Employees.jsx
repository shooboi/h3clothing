...
const Employees = () => {
    return (
        <div className='rounded-3xl border-radious sm:pt-16 mt-16 m-3 md:m-8 md:p-10 w-auto h-auto max-w-full max-h-full object-contain bg-white'>
            <Header category="Page" title="Employees"></Header>
            <div className='relative w-full h-10 mb-3 '>
                <Link to="#" className='absolute text-white border-gray-300 rounded-md shadow-sm p-2 px-3 bottom-2 bg-green-600 flex items-center'><AiOutlinePlus /> Add new </Link>
            </div>
                        ...
                        <tr className="hover:bg-gray-50">
                            <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                <div className="relative h-10 w-10">
                                    <img className="h-full w-full rounded-full object-cover object-center" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="avatar" />
